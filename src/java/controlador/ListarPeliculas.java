    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                RequestDispatcher rd= request.getRequestDispatcher("tablainfo.jsp");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListarPeliculas</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListarPeliculas at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
